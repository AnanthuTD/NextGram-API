# Generated by Django 4.2 on 2023-04-28 01:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.CharField(max_length=300, unique=True)),
                ('like', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), size=None)),
                ('shares', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), size=None)),
